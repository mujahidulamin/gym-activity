                    ...
                    <div className="accordion-item">
                        <h2 className="accordion-header" id="headingOne">
                            <button className="accordion-button" type="button" data-bs-toggle="collapse"
                                ...
                                <span className="fw-bold text-black fs-4">
                    ...
                    <div className="accordion-item">
                        <h2 className="accordion-header" id="headingFour">
                            <button className="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                ...
                                <span className="fw-bold text-black fs-4">3. The other works of useEffect except Data Load</span>
                        ...
                        <div id="collapseFour" className="accordion-collapse collapse" aria-labelledby="headingFour"
                            ...
                            <div className="accordion-body">
                                ...
                                the useEffect()is used for causing side effects in functional components and it is also capable for handling componentDidMount, componentDidUpdate and componentWillUnmountlife-cycle methods of className based components into functional component.
                            </div>
                        </div>
                    </div>
                </div>
